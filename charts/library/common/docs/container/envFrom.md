...
- See the [Full Examples](envFrom.md#full-examples) section for complete examples.
...
You can opt out of this by setting [`expandObjectName`](envFrom.md#envfromsecretrefexpandobjectname) to `false`
...
You can opt out of this by setting [`expandObjectName`](envFrom.md#envfromconfigmaprefexpandobjectname) to `false`
