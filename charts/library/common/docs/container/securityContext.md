...
- See the [Full Examples](securityContext.md#full-examples) section for complete examples.
...
| Required   | ✅                                                                            |
| Helm `tpl` | ❌                                                                            |
| Default    | See [here](../securityContext.md#securitycontextcontainerrunasuser) |
...
| Required   | ✅                                                                             |
| Helm `tpl` | ❌                                                                             |
| Default    | See [here](../securityContext.md#securitycontextcontainerrunasgroup) |
...
| Required   | ✅                                                                                         |
| Helm `tpl` | ❌                                                                                         |
| Default    | See [here](../securityContext.md#securitycontextcontainerreadonlyrootfilesystem) |
...
| Required   | ✅                                                                                           |
| Helm `tpl` | ❌                                                                                           |
| Default    | See [here](../securityContext.md#securitycontextcontainerallowprivilegeescalation) |
...
| Required   | ✅                                                                             |
| Helm `tpl` | ❌                                                                             |
| Default    | See [here](../securityContext.md#securitycontextcontainerprivileged) |
...
| Required   | ✅                                                                               |
| Helm `tpl` | ❌                                                                               |
| Default    | See [here](../securityContext.md#securitycontextcontainerrunasnonroot) |
...
If at least one capability is defined in either [`add`](securityContext.md#securitycontextcapabilitiesadd) or [`drop`](securityContext.md#securitycontextcapabilitiesdrop)
...
| Required   | ✅                                                                               |
| Helm `tpl` | ❌                                                                               |
| Default    | See [here](../securityContext.md#securitycontextcontainercapabilities) |
...
| Required   | ✅                                                                                  |
| Helm `tpl` | ❌                                                                                  |
| Default    | See [here](../securityContext.md#securitycontextcontainercapabilitiesadd) |
...
| Required   | ✅                                                                                   |
| Helm `tpl` | ❌                                                                                   |
| Default    | See [here](../securityContext.md#securitycontextcontainercapabilitiesdrop) |
...
| Required   | ✅                                                                                 |
| Helm `tpl` | ❌                                                                                 |
| Default    | See [here](../securityContext.md#securitycontextcontainerseccompprofile) |
...
| Required   | ✅                                                                                     |
| Helm `tpl` | ❌                                                                                     |
| Default    | See [here](../securityContext.md#securitycontextcontainerseccompprofiletype) |
...
| Required   | ✅                                                                                        |
| Helm `tpl` | ❌                                                                                        |
| Default    | See [here](../securityContext.md#securitycontextcontainerseccompprofileprofile) |
