...
- See the [Full Examples](podDisruptionBudget.md#full-examples) section for complete examples.
...
[`minAvailable`](podDisruptionBudget.md#minavailable), [`maxUnavailable`](podDisruptionBudget.md#maxunavailable)
