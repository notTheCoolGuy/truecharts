...
- See the [Full Examples](resources.md#full-examples) section for complete examples.
...
See [Resources Requests GPU](container/resources.md#resourceslimitsgpuintelcomi915)
