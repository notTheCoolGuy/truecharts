...
{{- define "asa.v1.common.class.priorityclass" -}}
...
metadata:
  ...
  namespace: {{ include "asa.v1.common.lib.metadata.namespace" (dict "rootCtx" $rootCtx "objectData" $objectData "caller" "Priority Class") }}
