{{/* CronJob Spec */}}
{{/* Call this template:
{{ include "asa.v1.common.lib.workload.cronjobSpec" (dict "rootCtx" $rootCtx "objectData" $objectData) -}}
...
objectData:
  ...
  +jobSpec data
*/}}
{{- define "asa.v1.common.lib.workload.cronjobSpec" -}}
...
jobTemplate:
  spec:
    {{- include "asa.v1.common.lib.workload.jobSpec" (dict "rootCtx" $rootCtx "objectData" $objectData) | indent 4 }}
{{- end -}}
