...
{{/* Call this template:
{{ include "asa.v1.common.spawner.imagePullSecret" $ -}}
*/}}

{{- define "asa.v1.common.spawner.imagePullSecret" -}}
  ...
  {{- range $name, $imgPullSecret := .Values.imagePullSecret -}}
    ...
    {{- if eq $enabled "true" -}}
      ...
      {{- include "asa.v1.common.lib.metadata.validation" (dict "objectData" $objectData "caller" "Image Pull Secret") -}}
      {{- $data := include "asa.v1.common.lib.imagePullSecret.createData" (dict "rootCtx" $ "objectData" $objectData) -}}
      ...
      {{- include "asa.v1.common.class.secret" (dict "rootCtx" $ "objectData" $objectData) -}}
