...
{{/* Call this template:
{{ include "asa.v1.common.spawner.priorityclass" $ -}}
*/}}

{{- define "asa.v1.common.spawner.priorityclass" -}}
  ...
  {{- range $name, $priorityclass := .Values.priorityClass -}}
    ...
    {{- if eq $enabled "true" -}}
      ...
      {{- include "asa.v1.common.lib.metadata.validation" (dict "objectData" $objectData "caller" "priorityclass") -}}
      ...
      {{/* Validate */}}
      {{- include "asa.v1.common.lib.priorityclass.validation" (dict "rootCtx" $ "objectData" $objectData) -}}
      {{/* Call class to create the object */}}
      {{- include "asa.v1.common.class.priorityclass" (dict "rootCtx" $ "objectData" $objectData) -}}
