{{/* Secret Spawwner */}}
{{/* Call this template:
{{ include "asa.v1.common.spawner.secret" $ -}}
*/}}

{{- define "asa.v1.common.spawner.secret" -}}
  ...
  {{- range $name, $secret := .Values.secret -}}
    ...
    {{- if eq $enabled "true" -}}
      ...
      {{- include "asa.v1.common.lib.metadata.validation" (dict "objectData" $objectData "caller" "Secret") -}}
