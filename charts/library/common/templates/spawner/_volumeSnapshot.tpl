...
{{/* Call this template:
{{ include "asa.v1.common.spawner.volumesnapshot" $ -}}
*/}}

{{- define "asa.v1.common.spawner.volumesnapshot" -}}
  ...
  {{- range $name, $volumesnapshot := .Values.volumeSnapshots -}}
    ...
    {{- if eq $enabled "true" -}}
      ...
      {{- include "asa.v1.common.lib.volumesnapshot.validation" (dict "objectData" $objectData) -}}
      {{- include "asa.v1.common.lib.metadata.validation" (dict "objectData" $objectData "caller" "VolumeSnapshot") -}}
      ...
      {{- include "asa.v1.common.class.volumesnapshot" (dict "rootCtx" $ "objectData" $objectData) -}}
