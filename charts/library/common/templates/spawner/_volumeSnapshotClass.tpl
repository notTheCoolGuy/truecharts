...
{{/* Call this template:
{{ include "asa.v1.common.spawner.volumesnapshotclass" $ -}}
*/}}

{{- define "asa.v1.common.spawner.volumesnapshotclass" -}}
  ...
  {{- range $name, $volumesnapshotclass := .Values.volumeSnapshotClass -}}
    ...
    {{- if eq $enabled "true" -}}
      ...
      {{- include "asa.v1.common.lib.volumesnapshotclass.validation" (dict "objectData" $objectData) -}}
      {{- include "asa.v1.common.lib.metadata.validation" (dict "objectData" $objectData "caller" "Volume Snapshot Class") -}}
      ...
      {{- include "asa.v1.common.class.volumesnapshotclass" (dict "rootCtx" $ "objectData" $objectData) -}}
